...
drug_name = st.text_input("Enter a drug name from the provided list of similar matches (case sensitive, no quotes!): ")

st.write("Note: Larger network graphs may take some time to load")
st.write("Below is the network graph for your chosen drug. You may need to click and drag in the box to see it.")
