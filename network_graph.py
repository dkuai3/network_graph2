...
st.title('Network Graph Visualization of ADE Data')
...
# st.write('You selected: ', drug_name)

#Get unique drug names
drugs = list(set(drugs))
drugs.sort()

drug_name = st.selectbox('Select a drug to visualize', drugs)
...
# print('Here are some close matches: ', close_matches)

# #Have user input final choice for drug name
# drug_name = input("Enter a drug name from the provided list of similar matches: ")

# print("Your chosen drug is " + drug_name)
